...
public class Main {
    ...
    public static final String ENTER_THE_NAME_OF_YOUR_VILLAGE = "Enter the name of your village";
    public static final int EVENT_RANK = 10;

    public static void main(String[] args) {

        System.out.println(ENTER_THE_NAME_OF_YOUR_VILLAGE);
    ...
    public static void event2(Village village, int i) {
        ...
        //why 10
        village.getTower().setLevel((int) village.getTower().getLevel() / EVENT_RANK);
